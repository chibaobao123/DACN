...
function veTableDatSanDanhSachThanhToan(data) {
	var html = "";
	html += "<div style='background-color: #d1dcde'><b>DANH SÁCH ĐÃ THANH TOÁN (" + data.length + ")</b><button class='btn btn-show'><i class='fas fa-caret-square-down'></i></button><button class='btn btn-hide d-none'><i class='fas fa-caret-square-up'></i></button></div>"
...
function veTableDatSanDanhSachHuy(data) {
	var html = "";
	html += "<div style='background-color: #d1dcde'><b>DANH SÁCH ĐANG YÊU CẦU HỦY SÂN (" + data.length + ")</b><button class='btn btn-show-huysan'><i class='fas fa-caret-square-down'></i></button><button class='btn btn-hide-huysan d-none'><i class='fas fa-caret-square-up'></i></button></div>"
