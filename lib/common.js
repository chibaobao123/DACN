...
const MSG_TEN_SDT =
  "- Tên phải có ít nhất 7 ký tự chữ cái không dấu.<br />- Số điện thoại phải đủ 10 số.<br/>- Số điện thoại phải bắt đầu bằng số '0'!!!";
  ...
  $.ajax({
    ...
    success: function (json) {
      ...
      for (var i = 0; i < data.length; i++) {
        $("#datsan_kh").append(
          new Option(data[i].ten + " (" + data[i].sdt + ")", data[i].id)
        );
      }
      $("#datsan_kh").chosen();
      ...
      for (var i = 0; i < d.length; i++) {
        ...
        for (j = 0; j < j2.length; j++) {
          if (j2[j].ma_san == d[i].ma_san) {
            var t =
              extractHourAndMins(j2[j].bat_dau) +
              "-" +
              extractHourAndMins(j2[j].ket_thuc);
            obj[k++] = t;
            found = true;
          }
        }
...
function veTableDatSanDanhSachThanhToan(data) {
  var html = "";
  html_content =
    "<div style='background-color: #d1dcde'><b>DANH SÁCH ĐÃ THANH TOÁN <span class='text-success'>(" +
    data.length +
    ")</span></b><button class='btn btn-show-thanhtoan'><i class='fas fa-caret-square-down'></i></button><button class='btn btn-hide-thanhtoan d-none'><i class='fas fa-caret-square-up'></i></button></div>";
  html +=
    "<table class='mytable mytable_thanhtoan ' style='width:100%; text-align: center' >";
  html +=
    "<thead><tr><th>#</th><th>Tên KH</th><th>SĐT</th><th>Sân</th><th>Bắt đầu</th><th>Kết thúc</th><th>Phút</th><th>Đơn giá (đồng/phút)</th><th>Tiền</th><th>Thanh toán</th></thead>";
  var tong_tien = 0;
  var da_thanh_toan = 0;
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if (thanh_toan == "1") {
      html +=
        `<td style='font-weight:bold;color:green;' onclick="chiTietHoaDon('${data[i].datsan_id}')" data-toggle="modal" data-target="#hoa_don_chi_tiet_da_thanh_toan">` +
        formatMoney(money) +
        "</td>";
    } else {
      html +=
        `<td style='font-weight:bold;color:red;' onclick="chiTietHoaDon('${data[i].datsan_id}')" data-toggle="modal" data-target="#hoa_don_chi_tiet_da_thanh_toan">` +
        formatMoney(money) +
        "</td>";
    }
    if (thanh_toan == "0") {
      html +=
        "<td><center><button class='btnThanhToan btn btn-light border border-dark' datsan_id='" +
        data[i].datsan_id +
        "'><i class='fas fa-check text-success'></i></button>";
    } else {
      html +=
        "<td><center><button disabled class='btnThanhToan btn btn-light border border-dark' datsan_id='" +
        data[i].datsan_id +
        "'><i class='fas fa-check text-success'></i></button>";
    }

    html +=
      "<button class=' btnXoaDatSanDanhSachThanhToan btn btn-light border border-dark' bat_dau='" +
      data[i].bat_dau +
      "' ket_thuc='" +
      data[i].ket_thuc +
      "'sdt='" +
      ...
      "' datsan_id='" +
      data[i].datsan_id +
      "'><i class='fas fa-times text-danger'></i></button></center></td>";
...
function veTableDatSanDanhSachHuy(data) {
  var html = "";
  html_content =
    "<div style='background-color: #d1dcde'><b>DANH SÁCH ĐANG YÊU CẦU HỦY SÂN <span class='text-danger'>(" +
    data.length +
    ")</span></b><button class='btn btn-show-huysan' ><i class='fas fa-caret-square-down'></i></button><button class='btn btn-hide-huysan d-none'><i class='fas fa-caret-square-up'></i></button></div>";
  html +=
    "<table class='mytable mytable_huysan' style='width:100%; text-align: center' >";
  html +=
    "<thead><tr><th>#</th><th>Tên KH</th><th>SĐT</th><th>Sân</th><th>Bắt đầu</th><th>Kết thúc</th><th>Phút</th><th>Đơn giá (đồng/phút)</th><th>Tiền</th><th>Thanh toán</th><th>Yêu cầu hủy đặt sân</th><th><center><button class='btn btn-light border border-dark btnAllDelete'><i class='fas fa-times text-danger'></i></button></center></th></thead>";
  var tong_tien = 0;
  var da_thanh_toan = 0;
  var chua_thanh_toan = 0;
  for (var i = 0; i < data.length; i++) {
    ...
    if (thanh_toan == "1") {
      html +=
        `<td style='font-weight:bold;color:green;' onclick="chiTietHoaDon('${data[i].datsan_id}')" data-toggle="modal" data-target="#hoa_don_chi_tiet_da_huy" >` +
        formatMoney(money) +
        "</td>";
    } else {
      html +=
        `<td style='font-weight:bold;color:red;' onclick="chiTietHoaDon('${data[i].datsan_id}')" data-toggle="modal" data-target="#hoa_don_chi_tiet_da_huy" >` +
        formatMoney(money) +
        "</td>";
    }
    if (thanh_toan == "0") {
    ...
    html +=
      "<button class='btnXoaDatSanDanhSachHuy btn btn-light border border-dark' bat_dau='" +
      data[i].bat_dau +
      "' ket_thuc='" +
      data[i].ket_thuc +
      "'sdt='" +
      ...
      data[i].datsan_id +
      "'><i class='fas fa-times text-danger'></i></button></center></td>";
    html += `<td onclick="chiTietHoaDon('${data[i].datsan_id}')" data-toggle="modal" data-target="#hoa_don_chi_tiet_da_huy"><center><span>` + data[i].note + "</span></center></td>";
    html +=
      "<td><center><span><input type='checkbox' class='choose' name='choose' value='choose' bat_dau='" +
      data[i].bat_dau +
      "' ket_thuc='" +
      data[i].ket_thuc +
      "'sdt='" +
...
function veTableDatSanIndex(data) {
  ...
  var html = "";
  html_content =
    "<div style='background-color: #d1dcde'><b>DANH SÁCH ĐẶT SÂN <span class='text-info'>(" +
    data.length +
    ")</span></b><button class='btn btn-show-index' ><i class='fas fa-caret-square-down'></i></button><button class='btn btn-hide-index d-none'><i class='fas fa-caret-square-up'></i></button></div>";
  html +=
    "<table class='mytable mytable_index' style='width:100%; text-align: center' >";
  html +=
    "<thead><tr><th>#</th><th>Tên KH</th><th>SĐT</th><th>Sân</th><th>Bắt đầu</th><th>Kết thúc</th><th>Phút</th><th>Đơn giá (đồng/phút)</th><th>Tiền</th><th>Thanh toán</th><th><center><button class='btn btn-light border border-dark btnAllDelete_index'><i class='fas fa-times text-danger'></i></button></center></th></thead>";
  var tong_tien = 0;
  var da_thanh_toan = 0;
  var chua_thanh_toan = 0;
  for (var i = 0; i < data.length; i++) {
    ...
    if (thanh_toan == "1") {
      html +=
        `<td style='font-weight:bold;color:green;  onclick="chiTietHoaDon('${data[i].datsan_id}')" data-toggle="modal" data-target="#hoa_don_chi_tiet"'>` +
        formatMoney(money) +
        `</td>`;
    } else {
      html +=
        `<td style='font-weight:bold;color:red;  onclick="chiTietHoaDon('${data[i].datsan_id}')" data-toggle="modal" data-target="#hoa_don_chi_tiet"'>` +
        formatMoney(money) +
        `</td>`;
    }
    if (thanh_toan == "0") {
    ...
    html +=
      "<button class='btnXoaDatSanIndex btn btn-light border border-dark' bat_dau='" +
      data[i].bat_dau +
      "' ket_thuc='" +
      data[i].ket_thuc +
      "'sdt='" +
...
function veTableDatSan(data) {
  ...
  html +=
    "<thead><tr><th>#</th><th>Tên KH</th><th>SĐT</th><th>Sân</th><th>Bắt đầu</th><th>Kết thúc</th><th>Phút</th><th>Tiền</th><th>Trạng thái</th><th>Thanh toán</th><th>Yêu cầu hủy đặt sân</th><th><center><button class='btn btn-light border border-dark btnAllDelete'><i class='fas fa-times text-danger'></i></button></center></th></tr></thead>";
  var tong_tien = 0;
  var da_thanh_toan = 0;
  var chua_thanh_toan = 0;
  for (var i = 0; i < data.length; i++) {
    ...
    if (thanh_toan == "0") {
      html +=
        "<td><center><button class='btnThanhToan_1 btn btn-light border border-dark' datsan_id='" +
        data[i].datsan_id +
        "'><i class='fas fa-check text-success'></i></button>";
    } else {
      html +=
        "<td><center><button disabled class='btnThanhToan_1 btn btn-light border border-dark' datsan_id='" +
        data[i].datsan_id +
        "'><i class='fas fa-check text-success'></i></button>";
    }

    html +=
      "<button class='btnXoaDatSan  btn btn-light border border-dark' bat_dau='" +
      data[i].bat_dau +
      "' ket_thuc='" +
      data[i].ket_thuc +
      "'sdt='" +
  ...
  html +=
    "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b>Đã thanh toán</b></td><td style='font-weight:bold;color:green;'>" +
    formatMoney(da_thanh_toan) +
    "</td><td></td><td></td><td></td></tr>";
  html +=
    "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b>Chưa thanh toán</b></td><td style='font-weight:bold;color:red;'>" +
    formatMoney(chua_thanh_toan) +
    "</td><td></td><td></td><td></td></tr>";
  html +=
    "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b>Tổng tiền</b></td><td style='font-weight:bold;color:blue;'>" +
    formatMoney(tong_tien) +
    "</td><td></td><td></td><td></td></tr>";
  html += "</table>";
      ...
      data.forEach((e) => {
        ...
        html += `
            <tr>
              ...
              <td input='1'>
                <input class='so_luong_kiem_ke_thuc_te' sanPham=${e.id} kho=${e.ton_kho} type="number" min="0" onchange="countChenhlech(this.value,${e.ton_kho},${e.id})" />
              </td>
              <td input='1'>
                <input value="-${e.ton_kho}" id="countChenhlech_${e.id}" disabled />
              </td>
            </tr>
            `;
        order++;
  ...
  $.ajax({
    ...
    success: function (json) {
      ...
      html += `
        ...
        `;
      total = `
        <table table class='mytable text-center mr-1' >

          <tbody class='border'>
            <tr>
              <td width='642'>Tổng:</td>
              <td width='195'>${formatMoney(tongTonKho)}</td>
              <td width='251'>${formatMoney(tongTien)}</td>
              <td>
...
function veXemPhieuKiemKe(data) {
  let html = "";
  html += `<div div class='container' style = 'height:500px; overflow-y:  auto' >
        <table class='mytable text-center' id='thongTinKhoHang' >
          <thead>
            <tr class="">
              <th>Mã phiếu kiểm</th>
...
async function chartDoanhThuSan() {
  ...
  let html = `
        <option option value = "-1" > --Doanh thu tất cả sân--</option >
          `

  let multiSelect = ''

  $('#chart_san_bong').html(`<canvas canvas id = 'ChartSanBong' ></canvas > `)
...
async function chartDoanhThuSanTheoThang(id) {
  ...
  $('#chart_san_bong').html(`<canvas canvas id = 'ChartSanBongTheoThang' ></canvas > `)
